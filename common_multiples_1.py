...
# the informatioin needed by the user is generated from the list of common multiples
...
print('\nThere are: ', cm, ' common multiples')
print('\nThe greatest common multiple is: ', gcm)
print('\nThe lowest common multiple is: ', lcm)

# the user is given the option to see all of the common multiples
show = input('\nDo you want to see all of the common multiples? (y = yes / n = no): ')
